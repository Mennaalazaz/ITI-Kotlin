...
import com.example.mvvmproductapp.databinding.FragmentProductAllBinding
import com.example.mvvmproductapp.ui.home.view.ProductAdapter
import com.example.mvvmproductapp.ui.home.viewModel.ProductViewModel
...
class AllProductFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter = ProductAdapter { product ->   // create instance of ProductAdapter
            val action =
                AllProductFragmentDirections.actionAllProductFragmentToOneProductFragment(  // passing a lambda (function) that defines what should happen when the user clicks on a product item.
        ...
        viewModel = ProductViewModel(ProductReposatory(RetrofitHelper()))


        viewModel.products.observe(viewLifecycleOwner,
            Observer { products -> // Observe the LiveData in the ViewModel Whenever the product list is updated in the ViewModel, update the adapter’s list
